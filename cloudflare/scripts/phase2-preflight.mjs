...
const required = [
  ...
  "WTFMEDIA_STAGING_CLERK_INSTANCE_REF", "WTFMEDIA_STAGING_CLERK_AUTHORIZED_PARTIES_REF",
  ...
  "WTFMEDIA_PRODUCTION_D1_REF", "WTFMEDIA_PRODUCTION_CLERK_INSTANCE_REF",
  "WTFMEDIA_PRODUCTION_CLERK_AUTHORIZED_PARTIES_REF", "WTFMEDIA_PRODUCTION_CACHE_NAMESPACE_REF",
  "WTFMEDIA_PRODUCTION_WORKER_ROUTE_REF", "WTFMEDIA_PRODUCTION_SECRET_SET",
];
const stagingResources = ["D1_REF", "CLERK_INSTANCE_REF", "CLERK_AUTHORIZED_PARTIES_REF", "CACHE_NAMESPACE_REF", "WORKER_ROUTE_REF", "SECRET_SET"];
