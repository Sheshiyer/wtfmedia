...
export type SettingsSection = {
  ...
  href: `/beta/ops/settings/${SettingsSectionId}`;
  label: string;
  eyebrow: string;
  description: string;
  status: string;
...
export const SETTINGS_SECTIONS: readonly SettingsSection[] = [
  {
    id: "readiness",
    href: "/beta/ops/settings/readiness",
  ...
  {
    id: "release",
    href: "/beta/ops/settings/release",
  ...
  {
    id: "analytics",
    href: "/beta/ops/settings/analytics",
  ...
  {
    id: "sessions",
    href: "/beta/ops/settings/sessions",
  ...
  {
    id: "sources",
    href: "/beta/ops/settings/sources",
    label: "RAG & sources",
