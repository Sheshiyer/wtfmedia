...
export default async function AuditPage() {
  ...
  return <div id="ops-main" className="mx-auto max-w-7xl px-4 py-8 sm:px-6"><p className="text-label">recorded evidence</p><h1 className="mt-3 font-display text-4xl lowercase">audit</h1><p className="mt-4 max-w-2xl text-lg">review only allowlisted administrative evidence.</p><AuditWorkspace /></div>;
}
