    ...
    <section className="rounded-panel border-2 border-foreground bg-surface-raised p-5 sm:p-6" aria-labelledby="memory-governance-title" id="memory-governance" data-memory-governance-panel>
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <article className="border-2 border-foreground bg-canvas p-4">
          ...
          <a href="/beta/ops/chat" className="mt-4 inline-flex min-h-10 items-center border-2 border-foreground bg-surface-subtle px-3 py-2 font-label text-xs font-bold lowercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-information">open sessions history</a>
        </article>
        <article className="border-2 border-foreground bg-canvas p-4">
