          ...
          <>
            ...
            <section className="mt-5 rounded-panel border-2 border-foreground bg-canvas p-5 sm:p-6" aria-labelledby="profile-settings-map-title" data-profile-settings-map>
              <div className="flex flex-wrap items-end justify-between gap-4 border-b-2 border-foreground pb-4">
                ...
                <Link href="/beta/ops/settings" className="inline-flex min-h-10 items-center border-2 border-foreground bg-surface-raised px-3 py-2 font-label text-xs font-bold lowercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-information">open settings directory</Link>
              </div>
