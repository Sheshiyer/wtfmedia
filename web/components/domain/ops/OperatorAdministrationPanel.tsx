...
export function OperatorAdministrationPanel() {
  ...
  return (
    ...
    >
      ...
      <Link href="/beta/ops/operators" className="mt-5 inline-flex min-h-11 items-center border-2 border-foreground bg-canvas px-4 py-3 font-label text-sm font-bold lowercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-information">
