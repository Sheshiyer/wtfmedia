...
function Count({ label, value }: { label: string; value: string | number }) {
  return (
    <div>
      <dt role="term" className="text-[11px] font-bold uppercase tracking-wider text-secondary">
        {label}
      </dt>
      <dd role="definition" className="mt-1 font-bold lowercase text-foreground">
        {value}
      </dd>
    </div>
  );
